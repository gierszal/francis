...
export const Sidebar: React.FC<SidebarProps> = ({
  ...
  const [fullyClosed, setFullyClosed] = useState<boolean>(true);
  ...
  return (
    <div
      className={clsx(
        "sm-scope fixed top-0 right-0 w-full z-5",
        !fullyClosed ? "w-full h-full z-50" : "w-fit h-fit",
      )}
    >
      <div
        ref={wrapperRef}
      ...
      >
        ...
        <header
          className="fixed top-0 right-0 staggered-menu-header absolute top-0 left-0 w-full flex items-center justify-between p-[2em] bg-transparent pointer-events-none z-20"
        ...
        >
          ...
          <button
            ref={toggleBtnRef}
            className={`sm-toggle border border-1 border-red-500 relative inline-flex items-center gap-[0.3rem] bg-transparent border-0 cursor-pointer font-medium leading-none overflow-visible pointer-events-auto ${
          ...
          >
            ...
            >
              <span
                ref={textInnerRef}
                className="sm-toggle-textInner flex flex-col leading-none mr-1"
              >
                {textLines.map((l, i) => (
                  <span
                    className="sm-toggle-line block h-[1em] leading-none flex flex-row"
                    key={i}
                  >
                    {l}
                  </span>
        ...
        <aside
          ...
          ref={panelRef}
          className="fixed top-0 right-0 h-screen staggered-menu-panel absolute top-0 right-0 h-full bg-white flex flex-col p-[6em_2em_2em_2em] overflow-y-auto z-10 backdrop-blur-[12px] pointer-events-auto"
          style={{
      ...
      <style>{`
    .sm-scope .staggered-menu-wrapper { position: relative;visibility: hidden;  width: 100%; height: 100%; z-index: 40; pointer-events: none; }
