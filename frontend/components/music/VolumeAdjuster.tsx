...
const VolumeAdjuster: React.FC<VolumeAdjusterProps> = ({
  defaultValue = 50,
  startingValue = 0,
  maxValue = 100,
  className = "",
  ...
  return (
    <>
      <motion.div
        ...
        className="flex flex-col w-full touch-none select-none items-center justify-center gap-2"
      >
        <motion.div
          animate={{
        ...
        <div
          ref={sliderRef}
          className="relative flex border border-2 border-red-500 w-full max-w-xs flex-grow cursor-grab touch-none select-none items-center py-4"
