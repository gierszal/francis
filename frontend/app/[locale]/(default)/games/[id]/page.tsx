      ...
      {gameAlbums.length ? (
        <>
          <div className="w-full md:w-[98%] mt-10 md:mt-20">
            <h1 className="text-2xl md:text-3xl mb-5">{t("albums")}</h1>
          ...
          <div className="mt-7 text-zinc-500 text-sm md:text-base">
            <span>{t("albumsAmount", { count: game.albums_amount })}</span>
          </div>
        </>
      ) : (
        <h1 className="mt-10 text-xl md:text-2xl">{t("albumsComingSoon")}</h1>
      )}
